...
class BookingExceptionHandler {
  ...
  /** What a student is told when they lose the race for an hour at the last moment. */
  ...
  @ExceptionHandler({HourUnavailable.class, HoldExpired.class, HoursNotOffered.class})
   ...
   *
   * <p>The transaction it happened in rolled back whole, which is why the message can promise that
   * nothing was charged.
   */
